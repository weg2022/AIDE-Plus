...
/* loaded from: /storage/emulated/0/AppProjects1/.ZeroAicy/git/AIDE+/build/classes.dex */
public class SigningService{
    ...
    public class b implements ValueRunnable<String>{
        ...
        public void j6(String str){
            try{
                SigningService.this.gn(this.j6, this.DW, str, this.FH);
            }
			catch (Throwable th){
    ...
    public class c implements ValueRunnable<String>{
        ...
        public void j6(String str){
            try{
                SigningService.this.FH(this.j6, this.DW, this.FH, str, this.Hw);
            }
			catch (Throwable th){
                throw new Error(th);
            }
    ...
    /* loaded from: /storage/emulated/0/AppProjects1/.ZeroAicy/git/AIDE+/build/classes.dex */
    private static class d implements ed.f{
    ...
    public void FH(String str, String str2, String str3, String str4, SigningRunnable signingRunnable){
        try{
            if ( j6 ){
        ...
        try{
            ...
            try{
                ...
                if ( list.size() == 1 ){
                    ...
                    MessageBox.VH(App.getMainActivity(), "Select keystore alias", list, new b(str, str2, signingRunnable));
                }
            }
			catch (Exception unused){
                MessageBox.BT(App.getMainActivity(), "Build Error", "Invalid keystore credentials!");
    ...
    public void gn(String str, String str2, String str3, SigningRunnable signingRunnable){
        try{
            if ( j6 ){
                iy.J0(5616900279404352443L, this, str, str2, str3, signingRunnable);
            }
            MainActivity mainActivity = App.getMainActivity();
            MessageBox.J8(mainActivity, (String) null, "Enter password for keystore alias '" + str3 + "':", new c(str, str2, str3, signingRunnable));
        }
		catch (Throwable th){
            if ( DW ){
    ...
    public boolean Hw(String str, String str2, String str3, String str4, Date date, Date date2, BigInteger bigInteger, String str5, String str6, String str7, String str8, String str9, String str10){
        try{
			...
			X509Certificate j62 = qq0Var.j6(privateKey, "BC");
			JKSKeyStore jKSKeyStore = new JKSKeyStore();
			jKSKeyStore.load(null, null);
			try{
				jKSKeyStore.setKeyEntry(str3, privateKey, str4.toCharArray(), new Certificate[]{j62});
        ...
        try{
            ...
            if ( signingConfig != null ){
                try{
                    ...
                    MessageBox.rN(App.getMainActivity(), "Build Error", "Failed to open signingConfig from build.gradle. Use alternative signing?", new a(str, signingRunnable), (Runnable) null);
                    return;
                }
            }
