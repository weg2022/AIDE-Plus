...
public final class PermissionFragment extends Fragment implements Runnable {
    ...
    public void splitTwiceRequestPermission(final Activity activity, final ArrayList<String> allPermissions,
                                            ArrayList<String> firstPermissions, final int requestCode) {
        ...
        PermissionFragment.launch(activity, firstPermissions, new PermissionInterceptor() {}, new OnPermissionCallback() {
					...
					PermissionUtils.postDelayed(new Runnable(){
							...
							public void run() {
								PermissionFragment.launch(activity, secondPermissions,
									new PermissionInterceptor(), new OnPermissionCallback() {
