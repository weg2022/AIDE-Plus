package io.github.zeroaicy.compiler.ecj.annotation;
			...
			switch ( this.getKind() ) {
				...
				case CLASS :
					...
					try {
						 ...
						 */
						ReferenceBinding type = this._filer._env.getCompiler().lookupEnvironment.getType(CharOperation.splitOn('.', this._typeName.toCharArray()));
						if ( type != null )
