...
public class ClassReader {
	...
	private static void loadDynamicDex() {
		...
		try {
			String readerclassDexFilePath = "/storage/emulated/0/AppProjects1/.project/ZeroAicy-WearOs/ReaderClassFile/bin/release/dex/classes.dex.zip";

			File file = new File("/storage/emulated/0/AppProjects1/.project/ZeroAicy-WearOs/ReaderClassFile/bin/release/dex/classes.dex.zip");
			if (!file.exists()) {
				isLoadDexError = true;
				return;
			}
